...
export function RegisterCompliance({ onAdd, onBack }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (minFont > 0) newCompany.compliances.push({ id: '1', type: 'min-font-size', value: minFont });
        if (disallowed.trim()) newCompany.compliances.push({ id: '2', type: 'disallowed-words', value: disallowed });
        if (tags.trim()) newCompany.compliances.push({ id: '3', type: 'required-tags', value: tags });
        if (noPrice) newCompany.compliances.push({ id: '4', type: 'no-price', value: true });
    ...
    return (
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '24px' }}>
                ...
                <h2 style={{ fontSize: '24px' }}>Register New Company Compliance</h2>
            </div>
